...
namespace Game.Server.Migrations
{
    ...
    [Migration("20210922103702_Added new column to SpyReport table")]
    partial class AddednewcolumntoSpyReporttable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Models.Models.Castle", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("AvailableCoinCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaximumCoinCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Models.Models.Tavern", b =>
                {
                    ...
                    b.Property<int>("MaximumSpyCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Models.Models.Unit", b =>
                {
                    ...
                    b.Property<TimeSpan>("RecruitTime")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Models.Models.UnitProductionQueueItem", b =>
                {
                    ...
                    b.ToTable("UnitProductionQueueItems");
                });

            modelBuilder.Entity("Models.Models.UpgradeQueueItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BackEnd.Models.Models.Castle", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.Models.City", "City")
                        .WithOne("Castle")
                        .HasForeignKey("BackEnd.Models.Models.Castle", "CityId");
            ...
            modelBuilder.Entity("BackEnd.Models.Models.Tavern", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.Models.City", "City")
                        .WithOne("Tavern")
                        .HasForeignKey("BackEnd.Models.Models.Tavern", "CityId");
